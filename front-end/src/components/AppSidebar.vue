...
<template>
  <aside class="app-sidebar" :class="{ collapsed: collapsed }">
    ...
    <div id="sidebar-content" class="sidebar-content" v-show="!collapsed">
      ...
      <div v-if="activeProjectName" class="project-banner" @click="goToProjects">
      ...
      <div v-else class="project-banner project-banner-empty" @click="goToProjects">
        <div class="d-flex align-items-center gap-2">
          <i class="bi bi-folder-plus flex-shrink-0"></i>
      ...
      <template v-if="currentPage === 'projects'">
        <div class="sidebar-section">
          ...
          <div v-if="!projectsList?.length" class="text-muted small px-2">
            No projects yet
          </div>
          <div
          ...
          >
            ...
            <i v-if="project.is_locked" class="bi bi-lock-fill text-warning ms-auto" style="font-size:0.7rem"></i>
          </div>
        </div>
      </template>
      ...
      <template v-if="currentPage === 'home'">
        <div class="sidebar-section">
          ...
          <button class="nav-btn" @click="goToImages">
      ...
      <!-- IMAGES PAGE -->
      <template v-if="currentPage === 'images'">
        <div class="sidebar-section">
          <span class="sidebar-section-title">Image Gallery</span>
          <div class="small text-muted px-2 mb-2">
            Upload and manage images for use in your report templates.
          </div>
          <div class="small px-2 mb-2">
            <strong>Using images in templates:</strong>
          </div>
          <div class="small text-muted px-2 mb-2" style="line-height:1.5">
            Copy an image URL and use it in your template HTML:<br>
...
.project-banner {
  background: linear-gradient(135deg, var(--pr-primary, #1b3a57) 0%, var(--pr-secondary, #2c5f8a) 100%);
  color: white;
  padding: 0.75rem;
  font-size: 0.9rem;
  font-weight: 600;
