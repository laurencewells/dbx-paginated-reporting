        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="card-body text-center p-4">
            ...
            <p class="card-text text-muted">
              Organise structures and templates into shareable projects
            </p>
            <button class="btn btn-outline-info" @click="navigate('/projects')">
        ...
        <div class="row g-4">
          <div class="col-md-3">
            <div class="d-flex">
              ...
              <div>
                <h6>Define Structure</h6>
                <p class="text-muted small mb-0">
                  Create a data model that matches your report data format
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="d-flex">
              ...
              <div>
                ...
                <p class="text-muted small mb-0">
                  Design your report layout using HTML and mustache tags
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="d-flex">
              ...
              <div>
                ...
                <p class="text-muted small mb-0">
                  Insert tiles, charts, and tables from the component palette
                </p>
              </div>
            </div>
          </div>
