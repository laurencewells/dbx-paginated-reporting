import{d as O,l as V,j as B,m as I,L as $,$ as F,V as N,c as o,a as r,b as u,y as b,z as v,g as H,D as s,E as h,a7 as S,o as l,_ as q}from"./index-DoTOKgdU.js";import{m as T}from"./mustache-lDDT9aR0.js";const G={class:"preview-view"},M={class:"toolbar mb-4 d-flex justify-content-between align-items-center"},U=["disabled"],W={key:0,class:"spinner-border spinner-border-sm me-1",role:"status"},Y={key:1,class:"bi bi-file-earmark-pdf me-1"},Z={key:0,class:"alert alert-info mb-4 d-flex align-items-center"},J={key:0},K={key:1},Q={class:"preview-container card"},X={class:"card-header d-flex justify-content-between align-items-center"},ee={key:0,class:"text-muted small"},te={class:"card-body p-0"},re={key:0,class:"empty-state"},ae={key:1,class:"d-flex justify-content-center align-items-center",style:{"min-height":"400px"}},oe=["srcdoc"],le=`
...
<\/script>`,se=O({__name:"PreviewView",setup(ne){const j=V(),C=B(),f=I(),g=s(()=>C.activeProjectId),w=s(()=>!!g.value),D=s(()=>({project_id:g.value})),R=s(()=>({project_id:g.value})),{data:E}=$(D,{query:{enabled:w}}),{data:A}=F(R,{query:{enabled:w}}),e=s(()=>(A.value??[]).find(a=>a.id===j.activeTemplateId)??null),c=h({}),p=h(!1),n=h(!1);async function L(){if(!e.value){c.value={};return}p.value=!0;try{const a=await S(e.value.id,{limit:10});c.value=a.data}catch{c.value={}}finally{p.value=!1}}N(()=>{var a;return(a=e.value)==null?void 0:a.id},()=>{L()},{immediate:!0});const x=s(()=>{if(!e.value)return"";try{return T.render(e.value.html_content??"",c.value)}catch{return""}});function y(a,t="Report"){return`<!DOCTYPE html>
<html><head>
<meta charset="utf-8">
