...
CREATE INDEX IF NOT EXISTS idx_projects_user_email
...
CREATE INDEX IF NOT EXISTS idx_project_shares_shared_with_email
    ON project_shares(shared_with_email);
...
CREATE INDEX IF NOT EXISTS idx_structures_project_id
    ON structures(project_id)"""
...
SEED_PROJECTS = """\
INSERT INTO projects (id, name, user_email, is_locked, is_global) VALUES
(
    'c0000000-0000-0000-0000-000000000001',
    'Samples',
    'samples@databricks.com',
    TRUE,
    TRUE
)
...
SEED_STRUCTURES = """\
INSERT INTO structures (id, name, project_id, fields, tables, selected_columns, sql_query) VALUES
(
